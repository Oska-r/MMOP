...
@onready var rocket_starting_sound: AudioStreamPlayer= $RocketStartingSound
...
func launch_rocket() -> void:
	main.background_music.volume_linear *= 0.2
	rocket_starting_sound.play()
	player.hide()
	label.hide()
	oxygen_tank.hide()
	UI.hide()
